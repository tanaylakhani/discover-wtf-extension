        ...
        <main className="flex-1 px-6 py-8 text-center">
          <div className="flex flex-col items-center gap-6">
            <div className="space-y-3">
              <h3 className="text-xl font-medium font-inter tracking-tight ">
                Welcome to <br />
                <span className="font-instrument">Discover.wtf</span>
              </h3>
              <p className="text-sm text-neutral-700 px-6 leading-relaxed">
            ...
            <div className="w-full space-y-3">
              <Button
                className="bg-orange-500 text-white w-full rounded-xl"
                onClick={handleLogin}
              >
                Sign In
              </Button>
